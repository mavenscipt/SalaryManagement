...
namespace SalaryManagement
{
    public partial class MasterRegistration : Form
    {
        ...
        private void UploadDocument()
        {
            ...
            //PanCard Upload Function...
            filename = "Pan_" + txtEmployeeName.Text + ".pdf";
            destUrl = @"PDF\" + txtEmployeeName.Text;
            SourcePath = Pan_textbox.Text;
            setFileName = System.IO.Path.Combine(destUrl, filename);
            if (!System.IO.Directory.Exists("PDF"))
            {
                System.IO.Directory.CreateDirectory(destUrl);
                copyFile(SourcePath, setFileName);
            ...
            //Election Card File Upload Function...
            filename = "Election_" + txtEmployeeName.Text + ".pdf";
            destUrl = @"PDF\" + txtEmployeeName.Text;
            SourcePath = Election_textbox.Text;
            setFileName = System.IO.Path.Combine(destUrl, filename);
            if (!System.IO.Directory.Exists("PDF"))
            {
                System.IO.Directory.CreateDirectory(destUrl);
        ...
        private void Save_Button_Click(object sender, EventArgs e)
        {
            ...
            if (Form_valid==true)
            {
                ...
                MessageBox.Show("Adhar:"+Adhar.ToString()+
                    "Employee Name:"+txtEmployeeName.Text+
                    "Image Path"+ImagePath+
                    "Gender"+cmbSex.SelectedItem.ToString()+
                    "Date Of Birth"+dtBirthDate.Value.ToString()+
                    "Age"+txtAge.Text+
                    "Permanent Address"+txtPermanentAddress.Text+
                    "Pincode"+txtPincode.Text+
                    "Personal Mobile"+txtPersonalMobile1.Text+
                    "Personal Mobile2"+txtPersonalMobile2.Text+
                    "Family Mobile"+txtFamilyMobile1.Text+
                    "Family Mobile2"+txtFamilyMobile2.Text+
                    "Reference Name"+txtReferenceName.Text+
                    "Reference Mobile"+txtReferenceMobile.Text+
                    "Original Document"+cmbOriginalDoc.SelectedItem.ToString()+
                    "Last Company Name"+txtLastCompanyName.Text+
                    "Last Company Work Time"+txtLastWorkTime.Text+
                    "Department"+cmbDepartment.SelectedValue.ToString()+
                    "Designation"+cmbDesignation.SelectedValue.ToString()+
                    "Category"+cmbEmployeecategory.SelectedItem.ToString()+
                    "Contractor"+cmbContract.SelectedValue.ToString()+
                    "Residential Status"+getResidentialStatus()+
                    "Salary Type"+getSalaryType()+
                    "Salary"+ txtSalary.Text+
                    "Adhar Path"+AdharPath+
                    "Pan PAth"+Pan_Path+
                    "Election Path"+Election_Path+
                    "Account Holder Name"+txtAcHolderName.Text+
                    "Bank Name"+txtBankName.Text+
                    "Branch Name"+txtBranchName.Text+
                    "IFSC Code"+txtISFCCode.Text+
                    "Account Number"+txtAcNumber.Text);
                string contractor = null;
                if (cmbEmployeecategory.SelectedItem.ToString() != "Direct")
                {
                    contractor = cmbContract.SelectedValue.ToString();
                }
                else
                ...
                cmd.Parameters.AddWithValue("@DOB", dtBirthDate.Value);
                cmd.Parameters.AddWithValue("@Age", Convert.ToInt32(txtAge.Text));
                cmd.Parameters.AddWithValue("@PersonMobile1", Convert.ToDouble(txtPersonalMobile1.Text));
                cmd.Parameters.AddWithValue("@PersonMobile2", Convert.ToDouble(txtPersonalMobile2.Text));
                cmd.Parameters.AddWithValue("@FamilyMobile1", Convert.ToDouble(txtFamilyMobile1.Text));
                cmd.Parameters.AddWithValue("@FamilyMobile2", Convert.ToDouble(txtFamilyMobile2.Text));
                cmd.Parameters.AddWithValue("@ReferenceMobile",Convert.ToDouble(txtReferenceMobile.Text));
                cmd.Parameters.AddWithValue("@ReferenceName", txtReferenceName.Text);
                cmd.Parameters.AddWithValue("@BankName", txtBankName.Text);
                cmd.Parameters.AddWithValue("@AcName",txtAcHolderName.Text);
                cmd.Parameters.AddWithValue("@AcNumber", txtAcNumber.Text);
                cmd.Parameters.AddWithValue("@Branch", txtBranchName.Text);
                cmd.Parameters.AddWithValue("@IFCS", txtISFCCode.Text);
                cmd.Parameters.AddWithValue("@EMpCategory",cmbEmployeecategory.SelectedItem.ToString() );
                cmd.Parameters.AddWithValue("@Department", SelectedItemId(cmbDepartment));
                cmd.Parameters.AddWithValue("@Designation", SelectedItemId(cmbDesignation));
                cmd.Parameters.AddWithValue("@contractor", SelectedItemId(cmbContract));
                cmd.Parameters.AddWithValue("@ResStatus", getResidentialStatus());
                cmd.Parameters.AddWithValue("@SalType", getSalaryType());
                cmd.Parameters.AddWithValue("@Salary", Convert.ToDouble(txtSalary.Text));
                cmd.Parameters.AddWithValue("@Address", txtPermanentAddress.Text);
                cmd.Parameters.AddWithValue("@Pincode", Convert.ToDouble(txtPincode.Text));
                cmd.Parameters.AddWithValue("@LastCoName", txtLastCompanyName.Text);
                cmd.Parameters.AddWithValue("@LastWorkTime", txtLastWorkTime.Text);
                ...
                cmd.Parameters.AddWithValue("@orignalDoc", cmbOriginalDoc.SelectedItem.ToString());
        ...
        void OpenFileDialog(TextBox txt)
        {
        ...
        private void CheckBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                OpenFileDialog(Aadhar_File_textbox);
            }
        }
        ...
        private void Election_checkbox_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                OpenFileDialog(Election_textbox);
            }
        }
