...
{
    public partial class FrmSalaryFix : Form
    {
        public FrmSalaryFix()
        {
            InitializeComponent();
        ...
        private void FrmSalaryFix_Load(object sender, EventArgs e)
        {
            ComboboxBind();
        }
        ...
        public double SalaryCalculation()
        {
            ...
            double BasicSalary = NumberConvertor(Salary);
        ...
        public int SaveSalary(int EmployeeId, string EmployeeName)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into  tblFixSalary " +
                "([EmployeeID],[EmployeeName],[BasicSalary],[Kharchi],[Upad],[RoomRent],[Present],[NetSalary],[Date]) values" +

            "('" + EmployeeId + "','" + EmployeeName + "','" + NumberConvertor(txtSalary.Text) + "','" + NumberConvertor(txtKharchi.Text) + "','" + NumberConvertor(txtUpad.Text) + "','" + NumberConvertor(txtRoomRent.Text) + "','" + NumberConvertor(txtPresent.Text) + "','" + NumberConvertor(txtNetSalary.Text) + "','" + today + "') ");
