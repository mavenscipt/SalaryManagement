        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
              ...
              if (validation)
              {
                  ...
                  {
                        int Role = 0;
                        if(cmbRole.SelectedItem.ToString() == "Normal")
                        {
                            Role = 1;
                        }
                        ...
                        else if(cmbRole.SelectedItem.ToString() == "Master Admin")
                        {
                            Role = 3;
                        }

                      int result = op.CreateUsers(txtUsername.Text.ToString(), txtPassword.Text.ToString(), Role);
                      if (result > 0)
                      {
